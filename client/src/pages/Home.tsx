                ...
                <div className="border-t pt-6">
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <button className="flex items-center justify-center gap-2 bg-black text-white rounded-lg py-2 px-3 hover:bg-gray-800 transition" data-testid="button-apple-wallet">
                        <Apple className="w-4 h-4" />
                        <span className="text-xs font-medium">Apple Wallet</span>
                      </button>
                      <button className="flex items-center justify-center gap-2 bg-white text-gray-800 border border-gray-300 rounded-lg py-2 px-3 hover:bg-gray-50 transition" data-testid="button-google-wallet">
